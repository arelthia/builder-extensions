...
if ( ! class_exists( 'ExtensionLongSidebar' ) ) {
	class ExtensionLongSidebar {
		function ExtensionLongSidebar() {
			require_once( dirname( __FILE__ ) . '/lib/content-widgets.php' );
	...
	$ExtensionLongSidebar = new ExtensionLongSidebar();
}